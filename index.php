        ...
        <section>
            <div class="row" style="height: 85px;">
                ...
                <div class="col d-flex justify-content-end">
                    <div class="row">
                        <div class="col">
                            <p class="text-center" id="version_text" style="font-weight: normal;padding-top: 12px;color: rgb(0,0,0);">CP 4.3.4<br><a href="https://github.com/magdesign/PocketVJ-CP-exh/issues" style="text-align: right;" target="_blank"><img class="help_logo" src="assets/img/help_issue.svg" style="text-align: right;padding: 8px;max-width: 60%;width: 40px;" data-toggle="tooltip" title="issues"></a><a href="/docs/html/index.html" style="text-align: right;" target="_blank"><img class="help_logo" src="assets/img/help.svg" style="text-align: right;padding: 8px;max-width: 60%;width: 40px;" data-toggle="tooltip" title="read the f**king docs!"></a><br></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-content" style="background: #ffffff;">
                    ...
                    <div class="tab-pane" role="tabpanel" id="tab-4">
                        ...
                        <div class="row no-gutters row-cols-1 row-cols-sm-2 row-cols-lg-4" style="margin-right: -15px;margin-left: -15px;background: #6cc6d9;padding-bottom: 20px;">
                            <div class="col">
                                <div>
                                    <h2 data-toggle="tooltip" title="">&nbsp;&nbsp;</h2>
                                    <div class="col colforbutton"></div>
                                </div>
                            </div>
                            <div class="col">
                                <div>
                                    <div class="col colforbutton">
                                        <h2><strong>SLIDESHOW after</strong><br></h2>
                                    </div>
                                    <div class="col colforbutton"><a class="btn btn-primary action" role="button" href="?action=enableslideafter" data-toggle="tooltip" title="enable slideshow after video played once">Enable</a></div>
                                    <div class="col colforbutton"><a class="btn btn-primary action" role="button" href="?action=disableslideafter" data-toggle="tooltip" title="disables slideshow after play once">Disable</a></div>
                                </div>
                            </div>
                            <div class="col">
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton1form-11" method="post" style="margin-left: 12px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton1" method="post" name="cpbutton1" onclick="SubmitBTNFormData();" value="startdmxplaybackaudio01once"><label class="form-check-label" for="formCheck-1">start dmx/aud 01_* once</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton1form-12" method="post" style="margin-left: 12px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton1" method="post" name="cpbutton1" onclick="SubmitBTNFormData();" value="startaudio01once"><label class="form-check-label" for="formCheck-1">startaudio 01_* once</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton1form-13" method="post" style="margin-left: 12px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton1" method="post" name="cpbutton1" onclick="SubmitBTNFormData();" value="startrandomaudio"><label class="form-check-label" for="formCheck-1">random audio</label></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton2form-6" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton2" method="post" name="cpbutton2" onclick="SubmitBTN2FormData2();" value="startimage"><label class="form-check-label" for="formCheck-1">slideshow</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                    ...
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton2form-11" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton2" method="post" name="cpbutton2" onclick="SubmitBTN2FormData2();" value="startdmxplaybackaudio02once"><label class="form-check-label" for="formCheck-1">start dmx/aud 02_* once&nbsp;</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton2form-12" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton2" method="post" name="cpbutton2" onclick="SubmitBTN2FormData2();" value="startaudio02once"><label class="form-check-label" for="formCheck-1">startaudio 02_* once&nbsp;</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton2form-13" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton2" method="post" name="cpbutton2" onclick="SubmitBTN2FormData2();" value="customfunction1"><label class="form-check-label" for="formCheck-1">customfunction1</label></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton3form-11" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton3" method="post" name="cpbutton3" onclick="SubmitBTN3FormData3();" value="startdmxplaybackaudio03once"><label class="form-check-label" for="formCheck-1">start dmx/aud 03_* once</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton3form-12" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton3" method="post" name="cpbutton3" onclick="SubmitBTN3FormData3();" value="startaudio03once"><label class="form-check-label" for="formCheck-1">startaudio 03_* once</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbutton3form-13" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbutton3" method="post" name="cpbutton3" onclick="SubmitBTN3FormData3();" value="customfunction2"><label class="form-check-label" for="formCheck-1">customfunction2</label></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row no-gutters row-cols-2 row-cols-lg-4" style="margin-right: -15px;margin-left: -15px;background: #574696;">
                            ...
                            <div class="col">
                                <div>
                                    ...
                                    <div class="col colforbutton"><a class="btn btn-warning action" role="button" id="submitBeacon1FormData" data-toggle="tooltip" title="set Beacon1 namespace" onclick="Submitbeacon1FormData();" value="set Beacon1" href="?action=setbeaconname">&lt;&nbsp; Set Beacon1</a></div>
                                    <div class="col colforbutton"><a class="btn btn-warning action" role="button" id="submitBeacon2FormData" data-toggle="tooltip" title="set Beacon2 namespace" onclick="Submitbeacon2FormData();" value="set Beacon2" href="?action=setbeaconname">&lt;&nbsp; Set Beacon2</a></div>
                                    <div class="col colforbutton"><a class="btn btn-warning action" role="button" id="submitBeacon3FormData" data-toggle="tooltip" title="set Beacon3 namespace" onclick="Submitbeacon3FormData();" value="set Beacon3" href="?action=setbeaconname">&lt;&nbsp; Set Beacon3</a></div>
                                    <div class="col colforbutton"><a class="btn btn-warning action" role="button" id="submitBeacon4FormData" data-toggle="tooltip" title="set Beacon4 namespace" onclick="Submitbeacon4FormData();" value="set Beacon3" href="?action=setbeaconname">&lt;&nbsp; Set Beacon4</a></div>
                                    <div class="col colforbutton">
                                        <h3>&nbsp;</h3>
                                    </div>
                                </div>
                            ...
                            <div class="col">
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton"><a class="btn btn-warning action" role="button" id="submitbtdelayFormData" onclick="SubmitbtdelayFormData();" value="Set Delay" data-toggle="tooltip" title="set delay time in seconds until beaconscanner starts again" href="?action=setbeaconname">Set Delay</a></div>
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbeacon1form-6" method="post" style="margin-left: 12px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbeacon1" method="post" name="cpbeacon1" onclick="SubmitCPBeacon1FormData();" value="startdmxplaybackaudio01b"><label class="form-check-label" for="formCheck-1">startdmx playback/audio 01_*</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbeacon2form-6" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbeacon2" method="post" name="cpbeacon2" onclick="SubmitCPBeacon2FormData();" value="startdmxplaybackaudio01b"><label class="form-check-label" for="formCheck-1">startdmx playback/audio 01_*</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbeacon3form-3" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbeacon3" method="post" name="cpbeacon3" onclick="SubmitCPBeacon3FormData();" value="startlessonce04b"><label class="form-check-label" for="formCheck-1">startvideo once 04_*</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbeacon3form-4" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbeacon3" method="post" name="cpbeacon3" onclick="SubmitCPBeacon3FormData();" value="startdmxplaybackonce03b"><label class="form-check-label" for="formCheck-1">startdmx playback once 03_*</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbeacon3form-5" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbeacon3" method="post" name="cpbeacon3" onclick="SubmitCPBeacon3FormData();" value="startdmxplaybackonce04b"><label class="form-check-label" for="formCheck-1">startdmx playback once 04_*</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbeacon3form-6" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbeacon3" method="post" name="cpbeacon3" onclick="SubmitCPBeacon3FormData();" value="startdmxplaybackaudio03b"><label class="form-check-label" for="formCheck-1">startdmx playback/audio 03_*</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                                        <form id="cpbeacon3form-7" method="post" style="margin-left: 10px;">
                                            <div class="form-check"><input class="form-check-input" type="radio" id="cpbeacon3" method="post" name="cpbeacon3" onclick="SubmitCPBeacon3FormData();" value="startdmxplaybackaudio04b"><label class="form-check-label" for="formCheck-1">startdmx playback/audio 04_*</label></div>
                                        </form>
                                    </div>
                                    <div class="col colforbutton" style="height: 24px;">
                        ...
                        <div class="row no-gutters row-cols-2 row-cols-lg-4" style="margin-right: -15px;margin-left: -15px;background: #ad325f;">
                            <div class="col">
                                ...
                                <div>
                                    ...
                                    <div class="col colforbutton" style="height: 68px;"></div>
                                    <div class="col colforbutton"><a class="btn btn-secondary action" role="button" id="dmxbuttoncolor" data-toggle="tooltip" title="play show05 only" href="?action=startdmxplayback05">&nbsp; &nbsp; &nbsp; &nbsp;Show05&nbsp; &nbsp; &nbsp; &nbsp;</a></div>
                                    <div class="col colforbutton" style="height: 68px;"></div>
                                </div>
                            </div>
                            <div class="col">
