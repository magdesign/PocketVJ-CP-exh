// This should be placed in /home/pvj/osc/osc_control.js to work with webCP
// or execute via terminal 'node osc_control.js'
...
exec("sudo su - pvj -c 'amixer set Master 10%+'");
});
...
exec("sudo /var/www/sync/setaudio_hdmi");
});

receiver.on('/audiojack', function () {
console.log('3.5mm Audio Jack Output');
exec("sudo /var/www/sync/setaudio_jack");
});

receiver.on('/audioboth', function () {
console.log('Audio Out Both 3.5mm Jack & HDMI');
exec("sudo /var/www/sync/setaudio_both");
});

receiver.on('/audioalsa', function () {
  console.log('Audio to usb alsa');
  exec("sudo /var/www/sync/setaudio_alsa");
  });
...
//# Special video scripts without stopall commands

receiver.on('/startlesser01', function () {
console.log('start video_01 loop without stopall');
exec("/var/www/sync/startlesser01");
});

receiver.on('/startlesser02', function () {
console.log('start video_02 loop without stopall');
exec("/var/www/sync/startlesser02");
});

receiver.on('/startlesser03', function () {
console.log('start video_03 loop without stopall');
exec("/var/www/sync/startlesser03");
});

receiver.on('/startlesser04', function () {
console.log('start video_04 loop without stopall');
exec("/var/www/sync/startlesser04");
});

receiver.on('/startlesser05', function () {
console.log('start video_05 loop without stopall');
exec("/var/www/sync/startlesser05");
});

//# Special video scripts without stopall (more speed!) commands and plying only once

receiver.on('/startlesseronce01', function () {
console.log('start video_01 once without stopall');
exec("/var/www/sync/startlesseronce01");
});

receiver.on('/startlesseronce02', function () {
console.log('start video_02 once without stopall');
exec("/var/www/sync/startlesseronce02");
});

receiver.on('/startlesseronce03', function () {
console.log('start video_03 once without stopall');
exec("/var/www/sync/startlesseronce03");
});

receiver.on('/startlesseronce04', function () {
console.log('start video_04 once without stopall');
exec("/var/www/sync/startlesseronce04");
});

receiver.on('/startlesseronce05', function () {
console.log('start video_05 once without stopall');
exec("/var/www/sync/startlesseronce05");
});

receiver.on('/startlesseronce06', function () {
console.log('start video_06 once without stopall');
exec("/var/www/sync/startlesseronce06");
});

receiver.on('/startlesseronce07', function () {
console.log('start video_07 once without stopall');
exec("/var/www/sync/startlesseronce07");
});

receiver.on('/startlesseronce08', function () {
console.log('start video_08 once without stopall');
exec("/var/www/sync/startlesseronce08");
});

receiver.on('/startlesseronce09', function () {
console.log('start video_09 once without stopall');
exec("/var/www/sync/startlesseronce09");
});

receiver.on('/startlesseronce10', function () {
console.log('start video_10 once without stopall');
exec("/var/www/sync/startlesseronce10");
});
...
//exec("sudo killall -9 /home/pvj/raspidmx/pngview/./pngview");
...
exec('sudo /home/pvj/NDI_SDK/examples/C++/NDIlib_Find/./NDIlib_Find');
});
...
//DMX Stuff
//Stop dmx playback/ dmx recording only

receiver.on('/stopdmx', function () {
  console.log('Stop DMX');
  exec("sudo /var/www/sync/stopdmx > /dev/null &");
  });

//start show with video

receiver.on('/startdmxvidplayback01', function () {
  console.log('Start DMX Show&Video 01');
  exec("sudo /var/www/sync/startdmxplaybackvid01 > /dev/null &");
  });

receiver.on('/startdmxvidplayback02', function () {
  console.log('Start DMX Show&Video 02');
  exec("sudo /var/www/sync/startdmxplaybackvid02 > /dev/null &");
  });

receiver.on('/startdmxvidplayback03', function () {
  console.log('Start DMX Show&Video 03');
  exec("sudo /var/www/sync/startdmxplaybackvid03 > /dev/null &");
  });

receiver.on('/startdmxvidplayback04', function () {
  console.log('Start DMX Show&Video 04');
...
// there are scripts up to 40, but only 1-5 are defined here:

receiver.on('/startdmxplayback01', function () {
  console.log('Start DMX Show01');
  exec("sudo /var/www/sync/startdmxplayback01 > /dev/null &");
  });

receiver.on('/startdmxplayback02', function () {
  console.log('Start DMX Show02');
  exec("sudo /var/www/sync/startdmxplayback02 > /dev/null &");
  });

receiver.on('/startdmxplayback03', function () {
  console.log('Start DMX Show03');
  exec("sudo /var/www/sync/startdmxplayback03 > /dev/null &");
  });

receiver.on('/startdmxplayback04', function () {
  console.log('Start DMX Show04');
  exec("sudo /var/www/sync/startdmxplayback04 > /dev/null &");
  });

receiver.on('/startdmxplayback05', function () {
  console.log('Start DMX Show05');
...
receiver.on('/startdmxrecord01', function () {
  console.log('Start recording DMX Show01');
  exec("sudo /var/www/sync/startdmxrecord01 > /dev/null &");
  });

receiver.on('/startdmxrecord02', function () {
  console.log('Start recording DMX Show02');
  exec("sudo /var/www/sync/startdmxrecord02 > /dev/null &");
  });

receiver.on('/startdmxrecord03', function () {
  console.log('Start recording DMX Show03');
  exec("sudo /var/www/sync/startdmxrecord03 > /dev/null &");
  });

receiver.on('/startdmxrecord04', function () {
  console.log('Start recording DMX Show04');
  exec("sudo /var/www/sync/startdmxrecord04 > /dev/null &");
  });

receiver.on('/startdmxrecord05', function () {
  console.log('Start recording DMX Show05');
  exec("sudo /var/www/sync/startdmxrecord05 > /dev/null &");
  });


//midi control

receiver.on('/startmidicontrol', function () {
  console.log('Start/Enable Midi control');
  exec("sudo /var/www/sync/startmidicontrol > /dev/null &");
  });

receiver.on('/stopmidicontrol', function () {
  console.log('stop/Enable Midi control');
  exec("sudo /var/www/sync/stopmidicontrol > /dev/null &");
  });

// this is for function output..
